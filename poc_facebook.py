...
# My target here is Facebook, but the issue is in no way specific to this website
# ================================================================
# To run
# Make sure you are logged in Facebook, then browse to the server
...
function set_user_data(url)
{
    if (!url) document.getElementById("hello").innerHTML = "Failed";
        ...
        {
            document.getElementById("hello").innerHTML = "Failed. Are you logged into Facebook?";
        }
        else
        {
            var username = url.split("/")[3];
            document.getElementById("hello").innerHTML = "Your username is " + username;
